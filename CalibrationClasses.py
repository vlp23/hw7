...
class Calibration:
    ...
    def sample_posterior(self):
        ...
        for cohort_id in self._cohortIDs:
            ...
            proportion = multiCohort.get_list_survival()

            # construct a gaussian likelihood
            # with mean calculated from the simulated data and standard deviation from the clinical study.
            # evaluate this pmf (probability density function) at the mean reported in the clinical study.
            weight = stat.binom.pmf(
                k = CalibSets.OBS_survive,
                n = CalibSets.OBS_N,
                p = proportion,
                loc = 0)
