...
#Question 1: Modify the survival model classes to get the probability of death

    def get_probability_alive(self):
        """ returns the probability of a death """
        self._count_alive = 0
        for value in self._survivalTimes:
            if value > 5:
                self._count_alive += 1
        return self._count_alive / len(self._survivalTimes)
...
class MultiCohort:
    ...
    def __init__(self, ids, pop_sizes, mortality_probs):
        ...
        self._cohort_5year_survival = []
        self._prob5yrsurvival = []
    ...
    def simulate(self, n_time_steps):
        ...
        for i in range(len(self._ids)):
            ...
            #store 5 year survival time
            self._cohort_5year_survival.append(cohort.get_probability_alive())
            self._prob5yrsurvival.append(output.get_probability_alive())
    ...
    def get_list_survival(self):
        return self._cohort_5year_survival



#Question 2: This would follow a binomial distribution. The parameters are q is between 0 and  1.
#Question 3:

likelihood=stat.binom.pmf(k=400, n=573, p=.5)

print('Likelihood', stat.binom.pmf(k=400, n=573, p=.5))
